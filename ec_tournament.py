...
if __name__ == "__main__":
    ...
    assert (
        args.pop_size % args.num_tournament_winners == 0
    ), f"Error: select different num_tournament_winners: received {args.num_tournament_winners}"
